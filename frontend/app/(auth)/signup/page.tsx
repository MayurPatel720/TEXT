            ...
            <Form className="space-y-4">
              ...
              <div>
                ...
                <Field
                  ...
                  className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3 text-sm text-white placeholder-white/30 focus:outline-none transition-all ${errors.name && touched.name
              ...
              <div>
                ...
                <Field
                  ...
                  className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3 text-sm text-white placeholder-white/30 focus:outline-none transition-all ${errors.email && touched.email
                      ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20"
                      : "border-white/10 focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent)]/20"
                    }`}
                />
              ...
              <div>
                ...
                <div className="relative">
                  <Field
                    ...
                    name="password"
                    placeholder="••••••••"
                    className={`w-full bg-[#1a1a1a] border rounded-xl px-4 py-3 pr-12 text-sm text-white placeholder-white/30 focus:outline-none transition-all ${errors.password && touched.password
                        ? "border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20"
                        : "border-white/10 focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent)]/20"
                      }`}
                  />
